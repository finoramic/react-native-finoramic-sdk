...
public class FinoramicSdkModule extends ReactContextBaseJavaModule implements ActivityEventListener {
	...
	public FinoramicSdkModule(final ReactApplicationContext reactContext) {
		super(reactContext);
